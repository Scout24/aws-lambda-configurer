...
authors = [Author('Jens Zastrow', 'jens.zastrow_external@immobilienscout24.de')]
description = "aws-lambda-configurer - Resolve AWS lambda " \
              "configuration from description field and other sources (e.g. s3)"
